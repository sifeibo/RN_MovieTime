...
class CustomTheme extends Component {
    ...
    onSelectTheme(themeKey) {
        ...
        // 改变主体样式
        const {onThemeChangeColor} = this.props;
        onThemeChangeColor(ThemeFactory.createTheme(ThemeFlags[themeKey]).themeColor);
    }
    ...
    render() {
        let view = this.props.visible ? <View style={{flex: 1,
...
const mapDispatchToProps = dispatch => ({
    onThemeChangeColor: (theme) => dispatch(actions.onThemeChangeColor(theme))
});
